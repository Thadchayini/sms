<?php
    ...
    $result=mysqli_query($con,"SELECT `first_name`, `last_name` FROM `students` WHERE student_id=$student_id");
                ...
                <td><u>Choose Subjects</u></td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php echo $row_subject["subject_id"];?>"><?php echo $row_subject["subject_name"];?></label>
                        </td>
                    </tr>
